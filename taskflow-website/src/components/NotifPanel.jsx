...
export default function NotifPanel({ t, onClose }) {
    ...
    return (
        <>
            <div onClick={onClose} style={{ position: "fixed", inset: 0, zIndex: 40, background: isMobile ? "#000000a0" : "transparent" }} />
            <div className={isMobile ? "slideUpSheet" : "slideRight"} style={{
                position: "fixed", 
                ...(isMobile ? { bottom: 0, left: 0, right: 0, width: "100%" } : { top: 58, right: 14, width: 320 }), 
                zIndex: 50,
                ...
                <div style={{ flex: 1, maxHeight: isMobile ? "auto" : 380, overflowY: 'auto' }}>
